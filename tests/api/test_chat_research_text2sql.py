...
class TestChatResearchText2SQLAPI:
    ...
    def test_chat_research_missing_sse_header(self, test_client, sample_text2sql_request):
        ...
        response = test_client.post("/workflows/chat_research", json=sample_text2sql_request.model_dump())
    ...
    def test_text2sql_workflow_initialization(
        self, mock_agent_class, mock_get_client, test_client, sample_text2sql_request
    ):
    ...
    def test_text2sql_error_handling(self, mock_get_client, test_client):
        ...
        invalid_request = {"task": "", "namespace": "test"}  # Empty task

        response = test_client.post(
            "/workflows/chat_research", json=invalid_request, headers={"Accept": "text/event-stream"}
        )
